...
drop table locations, employees, departments;
...
select employees.first_name, employees.last_name, employees.department_id, department_name from employees
...
select employees.first_name, employees.last_name, departments.department_name, locations.location_id, locations.state_province
...
from employees left join departments d on d.department_id = employees.department_id;